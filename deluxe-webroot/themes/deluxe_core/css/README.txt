...
To use these stylesheets, rename the files and deluxe_core with the name of your theme.
...
deluxe_core-alpha-default-narrow.css  
...
deluxe_core-alpha-default-normal.css
...
deluxe_core-alpha-default-wide.css
